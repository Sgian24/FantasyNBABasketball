          ...
          <Row style={{height:"100vh"}}>
              ...
              <div className="form-container shadow bg-white rounded d-flex flex-column align-items-center " style={{width: "40vw"}} >   
                  ...
                  <Form className="w-100 d-flex flex-column align-items-center">
                      <Form.Group className="form-input w-100 d-flex justify-content-center mb-1" as={Row} controlId="formBasicPassword">
                      ...
                      <Form.Group className="form-input w-100 d-flex justify-content-center mb-1" as={Row} controlId="formBasicEmail">
