...
const RosterDashboard = ({roster, deleteRoster, setPlayerID, position, setPosition}) => {
  ...
  return (
       ...
       <div className='d-flex p-0 mb-2 gap-3 '>
        ...
        <Button onClick={() => setPosition(position === 1280? 570: 1280)} size="sm"  variant="outline-primary" style={{height: "4vh", width:"4vw", fontSize:"0.65rem"}}>DRAFT</Button>
       </div> 
        <Container className='d-flex align-items-center bg-white p-0 rounded border' style={{height:"17vh", overflowY:"hidden"}} >
